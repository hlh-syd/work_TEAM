...
```bash
python 05_run_all.py --timestamp 20260625_134014
```

### 分步运行

```bash
python 01_data_preprocessing.py --timestamp 20260625_134014
python 02_gene_features.py --timestamp 20260625_134014
python 03_model_training.py --timestamp 20260625_134014
python 04_multi_timepoint.py --timestamp 20260625_134014
```

## 结果目录结构

```
results/20260625_134014/
