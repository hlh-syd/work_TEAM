...
```bash
python 05_run_all.py --timestamp 20260625_204037
```

### 分步运行

```bash
python 01_data_preprocessing.py --timestamp 20260625_204037
python 02_gene_features.py --timestamp 20260625_204037
python 03_model_training.py --timestamp 20260625_204037
python 04_multi_timepoint.py --timestamp 20260625_204037
```

## 结果目录结构

```
results/20260625_204037/
